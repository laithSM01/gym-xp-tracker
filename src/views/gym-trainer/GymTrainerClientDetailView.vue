    ...
    <template v-else>
      ...
      <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-6">
        <div class="flex items-start justify-between gap-4 mb-5">
          ...
          <span
            class="text-sm font-semibold px-3 py-1 rounded-full ring-1 shrink-0"
        ...
        <div class="lg:col-span-1 flex flex-col gap-6">
          ...
          <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
            ...
            <div class="flex flex-col gap-3">
              ...
              <p v-if="awardSuccess" class="text-xs text-green-600 text-center font-medium">XP awarded successfully!</p>
      ...
      <!-- Log Measurement + Challenges grid -->
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 flex flex-col gap-6">
          ...
          <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
            ...
            <div v-if="activeChallenges.length === 0" class="text-sm text-gray-400">No active challenges.</div>
